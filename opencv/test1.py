...
src1 = cv.imread('opencv/data/A.jpg')
src2 = cv.imread('opencv/data/B.jpg')
if src1 is None:
...
if src2 is None:
    ...
    exit(0)
cv.namedWindow(title_window,cv.WINDOW_NORMAL | cv.WINDOW_KEEPRATIO )
trackbar_name = 'Alpha %d' % alpha_slider_max
