...
# ----------------------------------------
###### arguments of messagehandle must match with sendMessage
###### arguments of sendMessage must be named
###### 根據 https://media.readthedocs.org/pdf/pypubsub/v4.0.0_a/pypubsub.pdf
import glob
import os
import wx
...
class ViewerPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.slideTimer = wx.Timer()  ##### wx.Timer(None) is NOT OK
...
class ViewerFrame(wx.Frame):
    ...
    def initToolbar(self):
        ...
        openTool = self.toolbar.AddTool(wx.ID_ANY,"OPEN", open_ico, shortHelp="Open an Image Directory")
    ...
    def onOpenDirectory(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            #print(picPaths)
        ##### Publisher.sendMessage("updateimages", msg=picPaths) is NOT OK #####
        Publisher.sendMessage("updateimages", msg=picPaths)    
